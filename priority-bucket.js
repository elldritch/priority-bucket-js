 ...
 * Priority buckets are essentially associative arrays that map a priority to an array of values.
 * This is useful for iterating across an array in a specific order.
 * Higher priority entries are traversed first.
 */
(function(){
	"use strict";
	 ...
	 * @param value mixed The value to push.
	 * @param priority int The priority; defaults to zero. Higher priorities are traversed first.
	 */
	 ...
	 * @param func callable A function with which to traverse the bucket. It is passed the current item being traversed.
	 */
